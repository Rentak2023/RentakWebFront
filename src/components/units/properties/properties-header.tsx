      ...
      <div className="mt-10">
        <div className="flex flex-col items-center">
          <div className="flex items-center">
            <h3 className="text-4xl font-medium leading-normal text-[#0F172A] md:text-6xl md:leading-normal">
              {t("findA")}
            </h3>
            <div className="flex flex-col items-center">
              <h3 className="z-10 text-4xl font-medium leading-normal text-primary-600 md:text-6xl md:leading-normal">
                {t("perfectHome")}
              </h3>
