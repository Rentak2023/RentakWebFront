...
export default function HowItWorks() {
  const t = useTranslations("tenant.how-it-works");

  const steps = [
    {
      num: 1,
      image: "/images/tenant-how-it-works-1.png",
      title: t("step-1.title"),
      description: t("step-1.description"),
    },
    {
      num: 2,
      image: "/images/tenant-how-it-works-2.png",
      title: t("step-2.title"),
      description: t("step-2.description"),
    },
    {
      num: 3,
      image: "/images/tenant-how-it-works-3.png",
      title: t("step-3.title"),
      description: t("step-3.description"),
    },
    {
      num: 4,
      image: "/images/tenant-how-it-works-4.png",
  ...
  return (
    <Container className="flex flex-col items-center justify-stretch pt-24 sm:pt-32">
      ...
      <div className="flex w-full overflow-x-auto snap-x snap-mandatory gap-6 pb-6 lg:justify-center">
        {steps.map((step) => (
          <div
            key={step.num}
          ...
          >
            ...
            <div className="flex flex-col p-5">
              ...
              <p className="mt-2 text-sm text-orange-500 whitespace-pre-line">{step.description}</p>
            </div>
          </div>
        ))}
      </div>
