...
function Transaction({ transaction }: Readonly<{ transaction: Transaction }>) {
  return (
          ...
          <DialogContent className="max-w-7xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-4">
                <div className="flex gap-4 rounded-2xl p-4 shadow">
                  <div>
                    <h3 className="text-xl font-semibold text-primary-600">
                      Tenant info
                    </h3>
                    <p className="text-lg text-slate-700">Mohamed Elsayed</p>
                    <p className="text-slate-700">
                      Email Address: mohamedelsayed@gmail.com
                    </p>
                    <p className="text-slate-700">Phone Number: 0105236987</p>
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold text-primary-600">
                      Contract duration
